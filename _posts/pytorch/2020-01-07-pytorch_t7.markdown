...
![baby]({{ '/assets/img/CNN/Sruct1.png' | prepend: site.baseurl }})
...
![baby]({{ '/assets/img/CNN/Sruct2.png' | prepend: site.baseurl }})
...
![baby]({{ '/assets/img/CNN/Sruct3.png' | prepend: site.baseurl }})
...
![baby]({{ '/assets/img/CNN/Sruct4.png' | prepend: site.baseurl }})